function calculateTax() {
    ...
    if (result <= 100000) {
        ...
        resultElement.innerHTML += "<p>You can invest 60 percent of this in insurance cover and similar safe investments and the remaining in your preferred and researched mutual funds through SYSTEMATIC INVESTMENT PLAN (SIP). Popular mutual funds include HDFC Mutual Fund, ICICI Prudential Mutual Fund, and SBI Mutual Fund.</p>";
    } else if (result > 200000 && result <= 400000) {
        resultElement.innerHTML += "<p>You can start by investing 30 percent of this amount in insurance cover and similar safer investments and the remaining in your preferred and selected mutual funds through SYSTEMATIC INVESTMENT PLAN (SIP). Popular mutual funds include Axis Bluechip Fund, Mirae Asset Large Cap Fund, and Aditya Birla Sun Life Equity Fund.</p>";
    } else if (result > 400000) {
        resultElement.innerHTML += "<p>You can start by investing 20 percent of the amount in Insurance cover and other safer options, the other 30 percent in your preferred and researched mutual funds through SYSTEMATIC INVESTMENT PLAN (SIP) and the remaining 50 percent in banks through fixed deposits for constant and safe returns. Some top banks offering fixed deposits with attractive interest rates include XYZ Bank with interest rates ranging from 5.1% to 6.75%, ABC Bank with interest rates ranging from 3.50% to 6.25%, and IJK Bank with interest rates ranging from 4.00% to 6.30%.</p>";
    }
}